...
const userVerification = (name, idNumber, id) => {
    return `
    <!DOCTYPE html>
<html>
<head>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Hello ${name}(${idNumber}), tap the button below to confirm your email address. If you didn't create an account, you can safely delete this email.</p>
            </td>
          </tr>
          <!-- end copy -->
...
const sendMail = function (subject, receiver) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const mailOptions = {
                ...
                subject: subject,
                text: "",
                html: userVerification(receiver.firstname, receiver.idNumber, receiver._id),
            };
            // @ts-expect-error
